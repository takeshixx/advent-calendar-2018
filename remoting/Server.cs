...
namespace RemotingSample
{
  class Server
  {
    ...
    {
      // create a TCP channel and bind it to port 10
      TcpChannel remotingChannel = new TcpChannel(10);
      ...
      WellKnownServiceTypeEntry remoteObject = new WellKnownServiceTypeEntry(typeof(RemoteXmas), "rXmas", WellKnownObjectMode.SingleCall);
